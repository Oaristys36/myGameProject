...
export function GoogleButton({ onClick }: GenericButtonProps) {
  ...
  <svg  className="google-svg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262">
...
<span className="google-radiant">Google</span>
</button>
    )
};

export function GitButton({ onClick }: GenericButtonProps) {
    return(
        <button className="git-button" onClick={onClick}>
...
export function AppleButton({ onClick }: GenericButtonProps) {
    return (
